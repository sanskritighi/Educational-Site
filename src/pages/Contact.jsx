...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!localValidationOk) {
      setLoading(false);
      return;
    }
    setError({ api: null, name: null, email: null, phone: null, message: null });
    axios
      .post(`${API_URLS.contact}/`, {
        name: formData.name,
  ...
  return (
    <div className='w-full  md:h-screen overflow-auto flex justify-center items-center'>

      <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
        <div>
          <h1 className="text-3xl font-extrabold">Let's Talk</h1>
          <p className="text-sm text-gray-400 mt-3">Want to implement the same LMS solutions into your organization. Give us a call.</p>
          <div className="mt-12">
            ...
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                <a target="blank" href="mailto:admin@eduaid.com" className="text-blue-500 text-sm ml-3">
                  <strong>admin@eduaid.com</strong>
                </a>
              </li>
            </ul>
          </div>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div>
            ...
            {error.name && <span className='text-sm text-red-500 px-2'>{error?.name}</span>}
          </div>
          <div>
            <input onChange={handleChange} type='tel' placeholder='Phone'
              name='phone' minLength={10} maxLength={15} className="w-full rounded-md py-2.5 px-4 border text-sm outline-blue-500" />
          ...
          <div>
            ...
            <textarea onChange={handleChange} placeholder='Message' rows="6"
              name='message'
          ...
          <button
            ...
            className="text-white bg-blue-500 hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">
