...
const Addfiles = () => {
  ...
  const handleDelete = (fileid) => {
    axios
      .delete(`${API_URLS.deleteFiles}/${fileid}`)
      .then(() => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${API_URLS.createFiles}\\`, formData, {
        headers: {
          ...
          <div className="flex flex-col gap-2">
            <div className="mt-4 mb-2">
              ...
              <select
                ...
                id="category"
                name="category"
                className="w-full mt-1 p-2 cursor-pointer outline-gray-300 rounded bg-transparent outline outline-1"
              >
                ...
                >
                  <div className="border-2 w-full border-dashed border-gray-300 rounded-md py-2 text-xs px-8 flex flex-col items-center justify-center space-y-4">
                    ...
                    <span class="text-gray-500">
                      {categoryImg?.name || "Upload a Image"}
                    </span>
                  </div>
                  <input
                    onChange={(e) => setcategoryImg(onFileSelectChange(e))}
                    accept="image/*"
                    id="category_img"
                    name="category_img"
                    type="file"
              ...
              <div className="flex items-center my-2 w-full">
                ...
                >
                  <div className="border-2 w-full border-dashed border-gray-300 rounded-md py-2 text-xs px-8 flex flex-col items-center justify-center space-y-4">
                    <BsUpload />
                    <span class="text-gray-500">
                      {subjectImg?.name || "Upload an image"}
                    </span>
                  </div>
                  <input
                    onChange={(e) => setSubjectImg(onFileSelectChange(e))}
                    accept="image/*"
                    id="subject_img"
                    name="subject_img"
                    type="file"
              ...
              <div className="flex items-center my-2 w-full">
                ...
                >
                  <div className="border-2 w-full border-dashed border-gray-300 rounded-md py-2 text-xs px-8 flex flex-col items-center justify-center space-y-4">
                    <BsUpload />
                    <span class="text-gray-500">
                      {subjectFile?.name || "Upload a file"}
                    </span>
                  </div>
                  <input
                    onChange={(e) => setSubjectFile(onFileSelectChange(e))}
                    id="subject-file"
                    name="subject-file"
                    type="file"
                    class="absolute hidden"
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr className="text-left font-semibold bg-gray-500 text-gray-200">
              ...
              <th className="py-3 px-4 border-b ">Category Image</th>
              <th className="py-3 px-4 border-b ">Subject Image</th>
              <th className="py-3 px-4 border-b ">Subject File</th>
              ...
              <tr key={file.id}>
                ...
                <td className="py-4 px-6 border-b">
                  <img
                    ...
                    className="aspect-sqaure w-20"
                  />
                </td>
                <td className="py-4 px-6 border-b">
                  <img
                    src={file.subject_image}
                    className="aspect-sqaure w-20"
                  />
                </td>
                <td className="py-4 px-6 border-b">
                  <a
                    href={file.subject_files}
                    className="aspect-sqaure flex items-center gap-2 text-blue-500"
                  >
                    Access File
                    <TbFileSymlink />
                  </a>
                ...
                <td className="py-4 px-6 border-b">
                  ...
                  <button
                    ...
                    className="text-red-500 hover:scale-110 hover:text-red-600"
                  >
